...
public class ProductServiceImpl implements ProductService {
	...
	public ProductDTO addProduct(Long categoryId, Product product) {
		...
		// ✅ OPTIMIZED: Use database query instead of iterating over fetched collection (O(1) vs O(N))
		boolean isProductPresent = productRepo.existsByProductNameAndDescriptionAndCategory(
				product.getProductName(), product.getDescription(), category);
