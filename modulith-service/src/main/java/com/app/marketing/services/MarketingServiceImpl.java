...
public class MarketingServiceImpl implements MarketingService {
    ...
    public void sendOrderSuccessEvent(OrderPaidEvent event) {
        if (apiKey == null || apiKey.isEmpty()) {
            System.out.println(">>> Dittofeed API Key missing. Logging event: Order #" + event.orderId() + " for "
                    + event.email());
            return;
        }
        ...
        try {
            ...
            System.out.println(">>> Marketing event sent to Dittofeed for Order: " + event.orderId());
        } catch (Exception e) {
