...
public class ERPNextService {
    ...
    @Autowired
    private com.app.repositories.OrderRepo orderRepo;
    ...
    @Autowired
    private com.app.repositories.ShipmentRepo shipmentRepo;

    private void updateShipmentInfo(Order order, JsonNode salesOrderData) {
        try {
            com.app.entites.Shipment shipment = order.getShipment();
            if (shipment == null) {
                shipment = new com.app.entites.Shipment();
