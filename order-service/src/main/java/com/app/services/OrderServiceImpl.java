...
public class OrderServiceImpl implements OrderService {
	...
	public OrderDTO placeOrder(String emailId, Long cartId, String paymentMethod) {
		...
		savedOrder.setOrderItems(orderItems); // Ensure items are set for sync

		// Sync to ERPNext
		// Running in separate thread to not block or fail the main order flow
		new Thread(() -> {
		...
		cart.getCartItems().forEach(item -> {
			...
			// NOTE: Stock update should happen via Event or API call to Product Service
