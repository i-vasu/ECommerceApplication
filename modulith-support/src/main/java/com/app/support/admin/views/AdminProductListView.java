...
public class AdminProductListView extends VerticalLayout {
        ...
        grid.addComponentColumn(p -> {
            ...
            Button deleteBtn = new Button(VaadinIcon.TRASH.create(), e -> {
                try {
                    ...
                    updateList();
                    com.vaadin.flow.component.notification.Notification.show("Deleted " + p.productName());
                } catch (Exception ex) {
    ...
    private HorizontalLayout getToolbar() {
        ...
        addProductButton.addClickListener(e -> com.vaadin.flow.component.notification.Notification.show("Add Product Dialog coming soon"));
