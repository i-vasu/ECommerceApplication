...
public class AppConstants {
	...
	public static final String[] PUBLIC_URLS = { "/v3/api-docs/**", "/swagger-ui/**", "/api/v1/register/**",
			"/api/v1/login",
			"/api/v1/public/**", "/api/v1/forgot-password", "/api/v1/reset-password", "/api/v1/verify-email",
