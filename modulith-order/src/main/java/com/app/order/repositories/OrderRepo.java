...
public interface OrderRepo extends JpaRepository<Order, Long> {
	...
	@Query("SELECT COUNT(o) > 0 FROM Order o JOIN o.orderItems oi WHERE o.email = ?1 AND oi.product.productId = ?2 AND o.orderStatus = com.app.governance.states.OrderStatus.DELIVERED")
